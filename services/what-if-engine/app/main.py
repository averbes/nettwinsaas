...
async def lifespan(app: FastAPI):
    ...
    logger.info("Starting NetTwinSaaS What-If Engine", version=settings.VERSION)
    ...
    logger.info("Shutting down NetTwinSaaS What-If Engine")


app = FastAPI(
    title="NetTwinSaaS What-If Engine",
    description="Network Digital Twin Simulation Engine",
...
async def root():
    """Root endpoint."""
    return {
        "service": "NetTwinSaaS What-If Engine",
        "version": settings.VERSION,
        "status": "operational",
        "docs_url": "/docs" if settings.DEBUG else None
    }
