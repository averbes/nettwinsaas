...
async def lifespan(app: FastAPI):
    ...
    logger.info("Starting NetTwinSaaS Topology Builder", version=settings.VERSION)
    ...
    logger.info("Shutting down NetTwinSaaS Topology Builder")


app = FastAPI(
    title="NetTwinSaaS Topology Builder",
    description="Network Topology Discovery and Management Service",
...
async def root():
    """Root endpoint."""
    return {
        "service": "NetTwinSaaS Topology Builder",
        "version": settings.VERSION,
        "status": "operational",
        "docs_url": "/docs" if settings.DEBUG else None
    }
